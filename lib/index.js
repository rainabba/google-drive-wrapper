...
ncfs.Drive.prototype.getFileMetadata = function(fileId) {
    const self = this;
...
ncfs.Drive.prototype.uploadFile = function(fileName, localPath, options) {
    const self = this;
    return new Promise((resolve, reject) => {
...
ncfs.Drive.prototype.downloadFile = function(fileId, localPath) {
    const self = this;
    return new Promise((resolve, reject) => {
        var extension = '';
...
ncfs.Drive.prototype.getMetaForFilename = function( drivePath ) {
    const self = this;
    return new Promise((resolve, reject) => {
        ...
        var findNext = function(parent, fileComponents, index) {
            ...
            .catch( err => {
                err.source = 'google-drive-wrapper:ncfs.Drive.js:getMetaForFilename:files.list';
                reject(err);
            });
        }
...
ncfs.Drive.prototype.listFilesBypath = function(gdrivePath, complete) {
    const self = this;
    return new Promise((resolve, reject) => {
...
ncfs.Drive.prototype.listFilesByFolderId = function(gdrivePath, complete) {
    return new Promise((resolve, reject) => {
        const self = this;
...
ncfs.Drive.prototype.mkdir = function( folderName, parentId ) {
...
ncfs.Drive.prototype.mkdirp = function(localPath) {
    const self = this;
    return new Promise((resolve, reject) => {
        // Get the names in the path, in order. The shift() is needed because the full path is injected in the first indice in the pathSplit function
...
ncfs.Drive.prototype.mv = function( sourceFilePath, destFilePath ) {
    const self = this;
    return new Promise((resolve, reject) => {
...
ncfs.Drive.prototype.pathSplit = function(path) {
    let sep = '/',
